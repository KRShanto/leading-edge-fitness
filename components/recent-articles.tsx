...
const articles = [
  {
    ...
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-6fmBdghadf93ArVIhRpinW90XuZGim.png",
  },
  {
    title: "Improve Your Swing Speed and Your Golf Game",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-ZVVATSRbNJ6nCEkt9b6i7ok0fZKIfi.png",
  },
  {
    title: "What Goes Into A Great Functional Workout",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-kXGM9uEQLltClfsYkfVRx0Thu7TwbC.png",
  },
  {
    title: "Starting A New Routine In The New Year!",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-VsOULuuhRpOOQynYyyU2Ru1ngv4n7x.png",
  },
  {
    title: "Best Season To Train For Golf",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-F04pHwXFAnL97jxxeWJC9ghXxcdJEU.png",
  },
  {
    title: "How Can I Improve My Hip Turn?",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-RJoSC4MQlTc3sEm6gN1W3vl2bd34WO.png",
  },
  {
    title: "Creating Upper and Lower Body Separation Improves Distance",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-i8QARDI7kYvb7ZCmZUGdtVAKgaDMIm.png",
  },
  {
    title: "Bigger Swings and Healthier Shoulders Make Golf More Fun",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-eXmEsj9O09pBaEaFIFtVzgHvxIZsrH.png",
  },
  {
    title: "Stretching For Better Golf",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-ZMRTKR5mJfK69iaL2jv1ayzMBWEbQI.png",
  },
  {
    title: "Why Does My Back Hurt When I Play Golf?",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-AavwfKGIDhQZKueHCfSgJcMuSCVQHX.png",
  },
];
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
            ...
            {articles.map((article, index) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <button className="mt-3 text-sm font-medium text-[#008080] hover:underline">
                    Read More →
                  </button>
                </div>
              </motion.div>
        ...
        <div className="flex justify-center mt-6 space-x-2">
          {Array.from({
            length: Math.ceil(articles.length / visibleSlides),
          }).map((_, idx) => (
            <button
              key={idx}
              className={`w-2 h-2 rounded-full transition-colors ${
                Math.floor(currentIndex / visibleSlides) === idx
                  ? "bg-[#008080]"
                  : "bg-gray-300"
              }`}
              onClick={() => {
